								...
								while($loose_accommodation_query->have_posts()){
									...
									<tr class="post-<?php the_ID(); ?> type-accommodation status-none" id="post-<?php the_ID(); ?>">
										<th class="check-column" scope="row">
											...
											<input type="checkbox" data-identifier="<?php echo $identifier; ?>" value="<?php the_ID(); ?>" name="post[]" id="cb-select-<?php the_ID(); ?>">
										</th>
										<td class="post-title page-title column-title">
											<strong><?php the_title(); ?></strong> - <a href="<?php echo admin_url('/post.php?post='.$post->ID.'&action=edit'); ?>" target="_blank"><?php echo $post->post_status; ?></a>
										</td>
