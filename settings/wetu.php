		...
		<tbody>
			...
			<tr class="form-field -wrap">
				...
				<td>
                    ...
                    <input type="radio" {{#is scaling value="w"}} checked="checked"{{/is}} name="scaling"  value="hw" /> Crop image to fit fully into the frame, but resize to width first, then crop on height if needed<br />
