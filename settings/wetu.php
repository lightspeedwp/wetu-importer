		...
		<tbody>
			...
			<tr class="form-field -wrap">
				...
				<td>
					...
					<input type="radio" {{#is scaling value="nc"}} checked="checked"{{/is}} name="scaling"  value="nc" /> Resize the image to fit within the frame. Image will not exceed specified dimensions
				</td>
			</tr>			
